...
if options.usercode:
  INDENT_LEVEL = None
  print(pg_logger_2.exec_script_str(options.usercode,
  ...
  if options.js_varname:
    ...
    print(pg_logger_2.exec_script_str(fin.read(), options.raw_input_lst_json, options.cumulative, options.heapPrimitives, js_var_finalizer))
  else:
    print(pg_logger_2.exec_script_str(fin.read(), options.raw_input_lst_json, options.cumulative, options.heapPrimitives, json_finalizer))